    ...
    <footer className="border-t border-border/50 bg-background">
      <div className="container mx-auto px-4 sm:px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground">
              Master fullstack development with structured, project-based learning.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <span className="text-sm text-text-tertiary">React (Coming Soon)</span>
              </li>
              <li>
                <span className="text-sm text-text-tertiary">Node.js (Coming Soon)</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-border/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © 2024 Notorious Coder. All rights reserved.
          </p>
